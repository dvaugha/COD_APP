            ...
            share: async function () {
                ...
                try {
                    ...
                    sn.innerHTML = `
                        ...
                        <div class="sn-sub">${new Date().toLocaleDateString()} • ${this.d.tee.toUpperCase()} • COD GOLF v280.4</div>
                        <div class="sn-sect">
            ...
            shareSimpleScorecard: async function () {
                ...
                try {
                    ...
                    node.innerHTML = `
                        ...
                        <div style="margin-top:20px; text-align:center; font-size:10px; color:#475569;">GENERATED BY COD GOLF v280.11</div>
                    `;
